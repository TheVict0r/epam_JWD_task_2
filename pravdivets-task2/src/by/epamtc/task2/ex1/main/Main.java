...
public class Main {
	...
	public static void main(String[] args) {
		...
		operator.takeBallByColor(basket, Color.ORANGE);
		operator.takeSpecifiedBall(basket, ball3);
		operator.fillBasket(basket, 50);
		
		System.out.println("Сейчас в корзине мячей - " + basket.getBallsInBasket());
		...
		Ball ball4 = operator.takeRandomBall(basket);
		System.out.println("Из корзины извечен случайный шар - " + ball4);
		System.out.println("Сейчас в корзине мячей - " + basket.getBallsInBasket());
